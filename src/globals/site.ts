            ...
            fields: [
                {
                    ...
                    options: [
                        ...
                        {
                            label: "America/Chicago (UTC-6 / UTC-5 DST)",
                            value: "America/Chicago",
                        },
                        {
                            label: "America/Denver (UTC-7 / UTC-6 DST)",
                        ...
                        {
                            label: "America/Adak (UTC-10 / UTC-9 DST)",
                            value: "America/Adak",
                        },
                        ...
                        {
                            label: "Europe/London (UTC+0 / UTC+1 DST)",
                            value: "Europe/London",
                        },
                        {
                            label: "Europe/Dublin (UTC+0 / UTC+1 DST)",
                            value: "Europe/Dublin",
                        },
                        {
                            label: "Europe/Paris (UTC+1 / UTC+2 DST)",
                            value: "Europe/Paris",
                        },
                        {
                            label: "Europe/Berlin (UTC+1 / UTC+2 DST)",
                            value: "Europe/Berlin",
                        },
                        {
                            label: "Europe/Rome (UTC+1 / UTC+2 DST)",
                            value: "Europe/Rome",
                        },
